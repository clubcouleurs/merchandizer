...
//App Showcase
        ...
        var AplAnimation = function (){
            ...
            jQuery(window).on('scroll', function() {
                if (jQuery(window).scrollTop() > 100) {
                    jQuery('.appilo-sticky').addClass('app-res-sticky-menu')
                } else {
                    jQuery('.appilo-sticky').removeClass('app-res-sticky-menu')
                }
            });
    ...
    //HRM Counter
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/circle-counter.default', function($scope, $){
            CircleCounter();
        } );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/seo2-portfolio.default', function($scope, $){
            Seo2Portfolio();
        } );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/medi-service.default', function($scope, $){
            MediService();
        } );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/medi-testimonial.default', function($scope, $){
            MediTestimonial();
        } );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/restaurant-slider.default', function($scope, $){
            ResSlider();
        } );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/it-testimonial.default', function($scope, $){
            ItTesti();
        } );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/it-blog.default', function($scope, $){
            ItBlog();
        } );
