...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'color',
    'settings'    => 'scroll_top_background',
    'label'       => esc_html__( 'Scroll Top', 'appilo' ),
    'description' => esc_html__( 'Change Scroll Top Background', 'appilo' ),
    'section'     => 'appilo_color_control',
    'default'     => '',
    'required'    => array(
        array(
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'color',
    'settings'    => 'scroll_top_hover_background',
    'description' => esc_html__( 'Change Scroll Top Hover Background', 'appilo' ),
    'section'     => 'appilo_color_control',
    'default'     => '',
    'required'    => array(
        array(
