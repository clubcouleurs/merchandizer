...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'typography',
    'settings'    => 'soft_m_scroll_top_color',
    'label'       => esc_html__( 'Scroll Top Color', 'appilo' ),
    'section'     => 'appilo_footer_options',
    'priority' => 100,
    'default'     => [
        'color'          => '',
...
Kirki::add_field( 'appilo_customizer', [
    'type'        => 'background',
    'settings'    => 'soft_m_main_scrolltop_bg',
    'label'       => esc_html__( 'Scroll Top Background Control', 'appilo' ),
    'section'     => 'appilo_footer_options',
    'default'     => [
        'background-color'      => '',
        'background-image'      => '',
