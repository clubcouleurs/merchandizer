...
function print_fontawesome_icons($id){
    $icons = get_fontawesome_icons();
    $keys = array_keys($icons);
    $print = $icons[ $keys[$id] ];
    print_r( '<i class="'.$print.'" aria-hidden="true"></i>');
}


require_once APPILO_ELEMENTOR_PATH.'elementor-category/elementor-cat.php';

$custom_widget_functions_list = glob(APPILO_ELEMENTOR_PATH.'widget-functions/*.php');
//Loop through the array that glob returned.
foreach($custom_widget_functions_list as $custom_widget_functions){
    require_once $custom_widget_functions;
}

function appilo_elementor_elements(){
...
add_action('elementor/widgets/widgets_registered','appilo_elementor_elements');