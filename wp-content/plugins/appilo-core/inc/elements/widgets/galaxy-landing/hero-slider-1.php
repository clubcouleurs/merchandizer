...
class hero_slider_one extends Widget_Base {
    ...
    protected function render() {
        ...
        echo '<!-- start of hero -->
        <section id="'.$settings['section_id'].'" class="hero hero-s1 parallax" data-bg-image="'.$settings['slider_bg']['url'].'" data-speed="5">
            <div class="container">
                <div class="row">
...
Plugin::instance()->widgets_manager->register_widget_type( new hero_slider_one );
?>