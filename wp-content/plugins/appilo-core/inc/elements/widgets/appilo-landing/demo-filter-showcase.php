...
echo '<!-- Start of demo section
 ============================================= -->
<section id="'.$settings['section_id'].'" class="demo-section">
    <div class="container">
            ...
            <div class="page-tab-button ul-li">
                ...
                if ( $settings['demo_cat_list'] ) {
                    foreach ($settings['demo_cat_list'] as $demo_category) {
                        echo '<li id="' . $demo_category['_id'] . '" class="filtr-button ' . $demo_category['active_cat'] . '" data-filter="' . $demo_category['cat_id'] . '">' . $demo_category['cat_title'] . ' </li>';
                    }
                }
                echo'</ul>
            </div>
        </div>
        <div id="'.$settings['section_id'].'" class="demo_item filtr-container row">';
...
Plugin::instance()->widgets_manager->register_widget_type( new demo_filter_showcase );
?>