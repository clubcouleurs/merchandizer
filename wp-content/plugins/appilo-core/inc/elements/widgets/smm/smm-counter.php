...
class smm_counter extends Widget_Base {
   ...
   public function get_icon() { 
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .smm-counter-text-icon p' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .smm-counter-text-icon p',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .smm-counter-text-icon .odometer' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .smm-counter-text-icon .odometer',
            ]
        );
        $this->add_control(
            'number_suff_color',
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .smm-counter-text-icon strong' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .smm-counter-text-icon strong',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .smm-counter-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'show_label' => true,
                'separator' => 'after',
                'selector' => '{{WRAPPER}} .smm-counter-text-icon:after',
            ]
        );
        $this->add_responsive_control(
            'section_padding',
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .smm-counter-section' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .smm-counter-wrapper',
            ]
        );
        $this->add_control(
            'mbc',
    ...
    ============================================= -->        
    <section id="' . $settings['section_id'] . '" class="smm-counter-section">
        <div class="container">
            <div class="smm-counter-wrapper">
                <div class="row">';
            if ( $settings['list'] ) {
                foreach ($settings['list'] as $item) {
                    echo'<div class="col-lg-3 col-md-6 smm-counter-dynamic' . $item['_id'] . '">
...
Plugin::instance()->widgets_manager->register_widget_type( new smm_counter );
?>