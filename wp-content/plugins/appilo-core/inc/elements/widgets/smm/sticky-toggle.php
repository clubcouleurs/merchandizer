    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'logo', [
                ...
                'default' => [
                    'url' =>  get_template_directory_uri(). '/img/smm/logo/logo1.png',
                ],
            ]
        );
        $this->add_control(
        ...
        $repeater->add_control(
            'image', [
                ...
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' =>  get_template_directory_uri(). '/img/smm/blog/br1.jpg',
                ],
            ]
        );
        $repeater->add_control(
...
echo '<!-- Start toggle section
        ============================================= -->        
        <div id="' . $settings['section_id'] . '" class="smm-sidebar-toggle-section">
            <div class="smm-side-bar-toggle smm-side-toggle-btn">';
                \Elementor\Icons_Manager::render_icon($settings['toggle_open'], ['aria-hidden' => 'true']);
            echo'</div>
            <div class="smm-sidebar-inner">
                ...
                \Elementor\Icons_Manager::render_icon($settings['toggle_close'], ['aria-hidden' => 'true']);
                echo'</div>
                    ...
                    echo'</ul>
                        ...
                        if ( $settings['social_list'] ) {
                            ...
                            echo '<li class="h-fb"><a '.$social_link.'>';\Elementor\Icons_Manager::render_icon($social['s_icon'], ['aria-hidden' => 'true']);echo'</a></li>';
                            }
                        }
                    echo'</ul>
                        </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new smm_toggle );
?>