                                    ...
                                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                                        <div class="inner-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                            <div class="image titlt" data-tilt data-tilt-max="8">
                                                <a href="'.$settings['section_image_1']['url'].'" class="app-1 lightbox-image"><img src="'.$settings['section_image_1']['url'].'" alt="App Block One" /></a>
                                            </div>
                                        </div>
                                    </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new topapp_app_block_one );
?>