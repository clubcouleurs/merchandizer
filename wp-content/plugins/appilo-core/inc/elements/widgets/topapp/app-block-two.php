...
class topapp_app_block_two extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'section_image_2', [
                'label' => __( 'Popup Image', 'appilo' ),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' =>  get_template_directory_uri(). '/img/topapp/resource/app-3.png',
                ],
            ]
        );
...
// Animation Variable
    ...
    protected function render() {
        ...
        echo '<!-- Apps Section -->
                <section class="apps-section" id="'.$settings['section_id'].'">
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
								<div class="image titlt" data-tilt data-tilt-max="8">
									<a href="'.$settings['section_image_1']['url'].'" class="app-2 lightbox-image"><img src="'.$settings['section_image_1']['url'].'" alt="Section Image oNe" /></a>
								</div>
								<div class="small-image titlt wow slideInRight" data-wow-delay="300ms" data-wow-duration="1500ms" data-tilt data-tilt-max="15">
									<a href="'.$settings['section_image_2']['url'].'" class="app-2 lightbox-image"><img src="'.$settings['section_image_2']['url'].'" alt="Section image 2" /></a>
								</div>
							</div>
						</div>
...
Plugin::instance()->widgets_manager->register_widget_type( new topapp_app_block_two );
?>