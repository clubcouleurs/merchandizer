...
class circle_counter extends Widget_Base {
   ...
   public function get_icon() { 
    ...
    ============================================= -->        
    <div id="' . $settings['section_id'] . '" class="counter-boxed seo-2-headline position-relative  wow fadeFromUp" data-wow-delay="100ms" data-wow-duration="1000ms">
...
Plugin::instance()->widgets_manager->register_widget_type( new circle_counter );
?>