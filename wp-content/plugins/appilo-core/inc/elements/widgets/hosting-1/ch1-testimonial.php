...
class ch1_testimonial extends Widget_Base {
    ...
    if ( $testimonial_style == 'simple' ) {
        echo '<section id="' . $settings['section_id'] . '" class="host-app-review-section">
...
echo '<section id="' . $settings['section_id'] . '" class="host-app-testimonial-section">
        <div class="container">
...
Plugin::instance()->widgets_manager->register_widget_type( new ch1_testimonial );
?>