...
echo'<section id="'.$settings['section_id'].'" class="saas_two_team_section">
    <div class="container">
                ...
                <div class="s2_tean_text">
                    <div class="s2_name_info saas2-headline">
                        ...
                        <div class="s2_mem_contact">
                            <span>';\Elementor\Icons_Manager::render_icon( $members['member_phn_icon'], [ 'aria-hidden' => 'true' ] ); echo''.$members['member_phn'].'</span>
                            <span>';\Elementor\Icons_Manager::render_icon( $members['member_mail_icon'], [ 'aria-hidden' => 'true' ] ); echo''.$members['member_mail'].'</span>
                        </div>
                    </div>
                </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new saas_classic_team );
?>