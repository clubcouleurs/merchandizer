...
class app_showcase_service extends Widget_Base {
    ...
    ============================================= -->
<section id="'.$settings['section_id'].'" class="eight-service-section position-relative">
    <div class="container">
...
Plugin::instance()->widgets_manager->register_widget_type( new app_showcase_service );
?>