...
class app_showcase_faq extends Widget_Base {
    ...
    ============================================= -->
<section id="'.$settings['section_id'].'" class="ei-faq-section position-relative">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="eight-section-title appeight-headline pera-content">
    										<span class="eg-title-tag">
    											'.$settings['headline'].'<i class="square-shape"><i></i><i></i> <i></i><i></i></i>
    										</span>
...
Plugin::instance()->widgets_manager->register_widget_type( new app_showcase_faq );
?>