...
class app_showcase_subscribe extends Widget_Base {
    ...
    ============================================= -->
<section id="'.$settings['section_id'].'" class="ei-newslatter-section position-relative">
...
Plugin::instance()->widgets_manager->register_widget_type( new app_showcase_subscribe );
?>