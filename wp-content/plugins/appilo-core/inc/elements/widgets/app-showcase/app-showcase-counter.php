...
class app_showcase_counter extends Widget_Base {
    ...
    ============================================= -->
<section id="'.$settings['section_id'].'" class="eg-fun-fact-section position-relative">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
Plugin::instance()->widgets_manager->register_widget_type( new app_showcase_counter );
?>