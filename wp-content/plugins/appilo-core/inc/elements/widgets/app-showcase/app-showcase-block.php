...
class app_showcase_block extends Widget_Base {
    ...
    ============================================= -->
<section id="'.$settings['section_id'].'" class="ei-appdownload-section position-relative" data-background="'.$settings['pattern_bg_1']['url'].'">
    <div class="container">
...
Plugin::instance()->widgets_manager->register_widget_type( new app_showcase_block );
?>