...
class app_showcase_slider extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => [ 'gradient' ],
                'show_label' => true,
                'selector' => '{{WRAPPER}} .eight-banner-section',
            ]
        );
        $this->add_group_control(
            Group_Control_Background::get_type(),
            [
                ...
                'show_label' => true,
                'selector' => '{{WRAPPER}} .eight-banner-section:after',
            ]
        );
    ...
    protected function render() {
    	...
    	============================================= -->
    	<section id="'.$settings['section_id'].'" class="eight-banner-section position-relative">
    		<div class="container">
    			<div class="row">
    				<div class="col-lg-12">
    					<div class="eight-banner-content">
    						<div class="banner-content-box appeight-headline pera-content">
    							...
    							<div class="ei-banner-btn">
    								<a href="'.$settings['slider_btn_url_1']['url'].'">';\Elementor\Icons_Manager::render_icon( $settings['slider_btn_icon'], [ 'aria-hidden' => 'true' ] ); echo''.$settings['slider_btn_1'].'</a>
    								<a href="'.$settings['slider_btn_url_2']['url'].'">'.$settings['slider_btn_2'].'</a>
    							</div>
...
Plugin::instance()->widgets_manager->register_widget_type( new app_showcase_slider );
?>