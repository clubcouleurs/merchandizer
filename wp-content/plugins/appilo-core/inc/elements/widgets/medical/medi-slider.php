...
============================================= -->
<section id="'.$settings['section_id'].'" class="medi-app-banner-section" data-background="'.$settings['image']['url'].'">
    <div class="container">
...
Plugin::instance()->widgets_manager->register_widget_type( new medi_slider );
?>