...
class app_startup_about extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'show_label' => true,
                'separator' => 'after',
                'selector' => '{{WRAPPER}} .str-about-section .str-about-content .str-progress-area .barfiller .tip',
            ]
        );
        $this->add_control(
            'p_title_color',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'show_label' => true,
                'separator' => 'after',
                'selector' => '{{WRAPPER}} .str-about-section .str-about-content .str-progress-area .barfiller .fill',
            ]
        );
        $this->end_controls_section();
        $this->start_controls_section(
    ...
    echo '<!-- Start of About Us section
            ============================================= -->
            <section id="' . $settings['section_id'] . '" class="str-about-section position-relative">
...
Plugin::instance()->widgets_manager->register_widget_type( new app_startup_about );
?>