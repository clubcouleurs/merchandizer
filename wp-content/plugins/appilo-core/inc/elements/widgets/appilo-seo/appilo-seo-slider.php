...
class appilo_seo_slider extends Widget_Base {
    ...
    ============================================= -->
<section id="'.$settings['section_id'].'" class="appseo-banner-section position-relative">
    <div class="container">
        <div  class="appseo-banner-content appseo-headline pera-content">
            ...
            if ($settings['slider_btn_1']){
                ...
                echo'<div class="banner-video-btn text-center">
                    <a href="'.$settings['slider_btn_url_2']['url'].'" class="lightbox-image overlay-box">';\Elementor\Icons_Manager::render_icon( $settings['slider_btn_icon'], [ 'aria-hidden' => 'true' ] );echo'</a>
...
Plugin::instance()->widgets_manager->register_widget_type( new appilo_seo_slider );
?>