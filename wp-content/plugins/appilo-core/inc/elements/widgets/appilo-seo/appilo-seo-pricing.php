...
class appilo_seo_pricing extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => 'no-popular',
                'options' => [
                    'popular-appseo'  => __( 'Popular', 'appilo' ),
                    'no-popular' => __( 'Normal', 'appilo' ),
                ],
            ]
        );
        $repeater->add_control(
    ...
    echo '<!-- Start of pricing section
        ============================================= --> 
        <section id="'.$settings['section_id'].'" class="appseo-pricing-section">
            <div class="container">
...
Plugin::instance()->widgets_manager->register_widget_type( new appilo_seo_pricing );
?>