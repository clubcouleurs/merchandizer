...
class digital_agency_slider extends Widget_Base {
    ...
    echo '<!-- Start of Banner section
        ============================================= -->    
        <section id="'.$settings['section_id'].'" class="dia-banner-section position-relative">
            ...
            <div class="banner-shape2 position-absolute" data-parallax='{"y" : 100, "rotateY":500}'><img src="<?php echo esc_url($settings['pattern_bg_2']['url'])?>" alt></div>
            <div class="banner-side-shape2 position-absolute" data-parallax='{"y" : -30}'><img src="<?php echo esc_url($settings['pattern_bg_3']['url'])?>" alt></div>
            <div class="banner-side-shape1 position-absolute" data-parallax='{"y" : 30}'><img src="<?php echo esc_url($settings['pattern_bg_4']['url'])?>" alt></div>
        </section>
...
Plugin::instance()->widgets_manager->register_widget_type( new digital_agency_slider );
?>