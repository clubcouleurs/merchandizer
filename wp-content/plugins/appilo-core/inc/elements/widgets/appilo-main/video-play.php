...
public function get_categories() {
   ...
   public function get_icon() { 
    ...
    protected function render() {
        ...
        echo '<section id="'.$settings['section_id'].'" class="appilo-video-box" style="background: #D9378B url('.$settings['video_bg']['url'].') center center no-repeat fixed; background-size: cover;">
...
Plugin::instance()->widgets_manager->register_widget_type( new appilo_video_play );
?>