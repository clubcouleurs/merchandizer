...
class appilo_feature_content_one extends Widget_Base {

   public function get_name() {
      return 'appilo-feature-content-one';
   }

   public function get_title() {
      return __( 'Feature Content One', 'appilo' );
   }
public function get_categories() {
   ...
   public function get_icon() { 
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Easy to Manage Your All Data <br/> by This App', 'appilo' ),
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'feature_image', [
                ...
                'default' => [
                    'url' => get_template_directory_uri(). '/img/1/data-moc.png',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        echo '<section class="features-style-one" id="'.$settings['section_id'].'">
                    <div class="container">
			...
			<div class="col-md-6">
				<img src="'.$settings['feature_image']['url'].'" class="has-dropshadow" alt="Awesome Image"/>
			</div>
            </div>
        </div>
    </section>';
...
Plugin::instance()->widgets_manager->register_widget_type( new appilo_feature_content_one );
?>