...
echo '<section  id="' . $settings['section_id'] . '" class="pm-feature-section-2 ' . $settings['feature_box_overflow'] . '"> <div class="pm-feature-content-2">
        <div class="container">
...
Plugin::instance()->widgets_manager->register_widget_type( new hrm_features );
?>