...
echo '<section id="'.$settings['section_id'].'" class="featured_service_section relative-position">
    <div class="container">
...
Plugin::instance()->widgets_manager->register_widget_type( new saas_features );
?>