...
<section id="'.$settings['section_id'].'" class="banner_section relative-position" data-background="'.$settings['main_bg']['url'].'">
...
Plugin::instance()->widgets_manager->register_widget_type( new saas_slider );
?>