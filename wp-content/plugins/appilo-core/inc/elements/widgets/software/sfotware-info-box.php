...
echo'<!-- Start of call to action section
    ============================================= --> 
    <section id="'.$settings['section_id'].'" class="soft-m-call-action-section position-relative">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
...
Plugin::instance()->widgets_manager->register_widget_type( new soft_call_action );
?>