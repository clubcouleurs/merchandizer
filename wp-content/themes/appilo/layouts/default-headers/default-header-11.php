...
<body <?php body_class('str-home'); ?> data-spy="scroll" data-target=".str-main-navigation" data-offset="50">

<?php if ($preloader_enable){ ?>
    <!-- preloader - start -->
    <div id="str-preloader"></div>
<?php } ?>
<div class="up">
    <a href="#" class="str-scrollup text-center"><i class="fas fa-angle-up"></i></a>
</div>

<!-- Start of header section
           ============================================= -->
<header id="str-header-main" class="default-str-header str-main-header">
    <div class="container">
