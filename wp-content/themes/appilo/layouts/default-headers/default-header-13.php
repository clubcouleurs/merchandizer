...
?>
<body <?php body_class('appl'); ?> data-spy="scroll" data-target=".main-navigation" data-offset="50">

<?php if ($preloader_enable){ ?>
    <div id="aplpreloader"></div>
<?php } ?>
<div class="up">
    <a href="#" class="appl-scrollup text-center"><i class="fas fa-angle-up"></i></a>
</div>
