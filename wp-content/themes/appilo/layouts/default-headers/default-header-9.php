...
<body <?php if (is_rtl()){ body_class('app-eight-home-rtl');}else{body_class('app-eight-home');} ?> data-spy="scroll" data-target=".navigation-eight" data-offset="50" >
            ...
            <ul>
                <?php if( $app_showcase_socials) {
                    foreach ($app_showcase_socials as $app_showcase_social) : ?>
                        <li><a href="<?php echo esc_url($app_showcase_social['social_link']); ?>"><i class="<?php echo esc_attr($app_showcase_social['icon_class']); ?>"></i></a></li>
                    <?php
                    endforeach;
                }
                ?>
