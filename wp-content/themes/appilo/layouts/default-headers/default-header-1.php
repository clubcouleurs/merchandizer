...
?>
<body data-spy="scroll" data-target=".navbar" <?php if (is_rtl()){ body_class('appilo-main-rtl appilo-main');}else{body_class('appilo-main');} ?>>
...
<section class="inner-banner" style="background: #000 url(<?php echo esc_url( $blog_details ); ?>) center center no-repeat; background-size: cover;">
    <?php } else { ?>
    <section class="inner-banner" style="background: #000 url(<?php echo get_template_directory_uri(); ?>/img/1/inner-banner-bg.jpg) center center no-repeat; background-size: cover;">
    <?php } ?>
