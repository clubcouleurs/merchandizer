        ...
        function appilo_widgets_init()
        {
            ...
            if (class_exists('Woocommerce')) {
                ...
                register_sidebar(array(
                    ...
                    'description' => esc_html__('Add widgets here.', 'appilo'),
                    'before_widget' => '<div id="%1$s" class="col col-md-3 col-6 %2$s"><div class="widget">',
                ...
                register_sidebar(array(
                    ...
                    'description' => esc_html__('Add widgets here.', 'appilo'),
                    'before_widget' => '<div id="%1$s" class="col col-md-2 col-6 %2$s"><div class="widget site-map-widget">',
                    'after_widget' => '</div></div>',
                    'before_title' => '<h3>',
                    'after_title' => '</h3>',
                ));
                register_sidebar(array(
                    ...
                    'description' => esc_html__('Add widgets here.', 'appilo'),
                    'before_widget' => '<div id="%1$s" class="col col-md-4 col-6 %2$s"><div class="widget newsletter-widget">',
                    'after_widget' => '</div></div>',
                    'before_title' => '<h3>',
                    'after_title' => '</h3>',
                ));
...
if (file_exists(get_template_directory() . '/admin/license-manager/Appilo.php')) {
    require_once get_template_directory() . '/admin/license-manager/Appilo.php';
}
